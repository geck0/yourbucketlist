...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Before6 - Kick your online bucket list</title>
  ...
  <body>
    ...
    <nav role="navigation" class="topbar">
      <div class="fill">
        <div class="container">
          <a class="brand" href="#">Before6</a>
          <ul class="nav">
            <li><a href="#home.html" rel="ajax">Home</a></li>
            <li><a href="#create.html" rel="ajax">Create List</a></li>
            <li><a href="#mylist.html" rel="ajax">My List</a></li>
          </ul>
        </div>
      </div>
    </nav> <!-- /navigation -->
